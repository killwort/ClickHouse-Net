...
public class ClickHouseParameterCollection : IEnumerable<ClickHouseParameter>, IDataParameterCollection {
    ...
    public ClickHouseParameter this[string parameterName] { get => _parameters.First(x => x.ParameterName == parameterName); set => _parameters[_parameters.FindIndex(x => x.ParameterName == parameterName)] = value; }
