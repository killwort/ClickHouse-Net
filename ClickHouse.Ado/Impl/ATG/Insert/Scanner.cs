...
internal class Scanner {
    ...
    private const int maxT = 18;
    private const int noSym = 18;
    ...
    static Scanner() {
        ...
        for (var i = 95; i <= 95; ++i) start[i] = 14;
        for (var i = 97; i <= 122; ++i) start[i] = 14;
        for (var i = 48; i <= 57; ++i) start[i] = 10;
        start[96] = 3;
        start[34] = 5;
        start[39] = 7;
        start[46] = 26;
        for (var i = 43; i <= 43; ++i) start[i] = 9;
        for (var i = 45; i <= 45; ++i) start[i] = 9;
        start[44] = 18;
        start[64] = 19;
        start[58] = 20;
        start[91] = 21;
    ...
    private Token NextToken() {
        ...
        switch (state) {
            ...
            case 2:
                ...
                return t;
            case 3:
                if (ch <= '!' || (ch >= '#' && ch <= '&') || (ch >= '(' && ch <= '[') || (ch >= ']' && ch <= '_') || (ch >= 'a' && ch <= 65535)) {
                    AddCh();
                    goto case 3;
                }
