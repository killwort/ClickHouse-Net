...
// instruction, especially if the shift is a manifest constant.
    ...
    private static UInt128 WeakHashLen32WithSeeds(byte[] s, ulong a, ulong b, int off) => WeakHashLen32WithSeeds(Fetch64(s, off), Fetch64(s, off + 8), Fetch64(s, off + 16), Fetch64(s, off + 24), a, b);
