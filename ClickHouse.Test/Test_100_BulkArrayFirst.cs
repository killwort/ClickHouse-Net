...
public class Test_100_BulkArrayFirst {
    ...
    public void TestRoundtrip() {
        using (var cnn = ConnectionHandler.GetConnection()) {
            cnn.CreateCommand("INSERT INTO test_100_arr_first (a,d) VALUES @bulk").AddParameter("bulk", DbType.Object, new object[] { new object[] { new[] { "a", "b" }, DateTime.Now } }).ExecuteNonQuery();
